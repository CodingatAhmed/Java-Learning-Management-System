...
public class AssignmentsList {
    ...
    public boolean AddAssignment(AssignmentQuestionsList newAssignmentQuestions) {
        if (AssignmentsList.totalAssignments < this.AllAssignmentsList.length) {
            this.AllAssignmentsList[AssignmentsList.totalAssignments] = new AssignmentQuestionsList(
    ...
    public void IterateAllAssignments() {
        for (AssignmentQuestionsList AssignmentSet : this.AllAssignmentsList) {
            System.out.println(AssignmentSet);
        }
    }
